                ...
                {draft.ctcAnnual ? (
                  <div className="overflow-hidden rounded-md border border-line">
                    <table className="w-full border-collapse text-[11px]">
                      <thead>
                        <tr className="bg-surface-hover font-semibold text-gray-700">
                            ...
                            <tr
                              ...
                              className={
                                r.highlight
                                  ...
                                  : r.strong
                                    ? 'bg-surface-sunken font-semibold text-gray-900'
                                    : 'text-gray-700'
                              }
                            >
                  ...
                  <p className="rounded-md bg-surface-muted p-2.5 text-[11px] text-gray-500">

              ...
              >
                ...
                {column.sortable ? (
                  ...
                  <input
                    ...
                    className={cn(
                      "min-w-0 flex-1 truncate appearance-none rounded-sm border-0 bg-transparent px-4 font-medium text-muted-foreground outline-none transition-colors focus:bg-muted focus:text-foreground",

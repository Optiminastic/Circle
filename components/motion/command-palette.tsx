          ...
          {({ isPresent, gate }) => (
            ...
            >
              <motion.div
                ...
                {...gate}
                onKeyDown={onKeyDown}
                className="pointer-events-auto w-full max-w-xl overflow-hidden rounded-lg border border-border bg-card shadow-2xl will-change-transform"
              >
                        ...
                        {list.map((it) => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                "relative isolate flex w-full items-center gap-3 rounded-sm px-2 py-2 text-left text-sm transition-colors",
                                isActive
                                  ? "text-foreground"
                            ...
                            >
                              {isActive ? (
                                <motion.span
                                  layoutId={`${uid}-active`}
                                  className="absolute inset-0 z-0 rounded-sm bg-muted/60"
                                  transition={
                                    reduce
                                      ? { duration: 0 }

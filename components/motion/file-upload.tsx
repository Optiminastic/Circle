...
function FileUploadRow({
  ...
  return (
    <motion.li
      ...
      className={cn(
        "relative overflow-hidden rounded-lg border border-border bg-background p-3",
        classNames?.item,
      )}
    >
      <div className="flex items-center gap-3">
        <div
          className={cn(
            "grid h-11 w-11 shrink-0 place-items-center rounded-md bg-muted text-muted-foreground",
            classNames?.leading,
          )}
        >
  ...
  return (
    <div className={cn("w-full space-y-3", className, classNames?.root)}>
      ...
      <button
        ...
        className={cn(
          "group relative flex w-full overflow-hidden rounded-lg border border-dashed border-border bg-background outline-none",

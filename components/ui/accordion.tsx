    ...
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          'flex flex-1 items-center justify-between gap-3 px-3 py-2 text-left text-[12px] font-semibold text-gray-900 transition hover:bg-surface-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 [&[data-state=open]>svg]:rotate-180',
          className,
        )}
        {...props}
      >

...
export const EMAIL_TEMPLATES: EmailTemplateDef[] = [
  ...
  },
  {
    ...
    description: 'Sent to the candidate for an online interview — just the Google Meet link.',
    group: 'hiring',
    placeholders: ['candidate_name', 'role', 'meet_link', 'hr_signoff'],
    defaultSubject: 'Your interview (online) — {{role}} — Optiminastic',
    defaultBody: [
      'Dear {{candidate_name}},',
      '',
      'Your interview for the {{role}} role will be held online. Please join using the link below.',
      '',

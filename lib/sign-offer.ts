 ...
 * short-lived (48h) doc-request whose single required doc is the signed copy, and
 ...
 * documents. The unguessable token in the URL is the credential.
 */
import { DocRequest } from '@/types';
import { repositories } from '@/lib/api/repositories';

export const SIGN_OFFER_TTL_HOURS = 48;
...
/** Create the 48h upload request and return it (its id is the link token). */

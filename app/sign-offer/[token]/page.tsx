...
import { SIGNED_OFFER_DOC, SIGN_OFFER_TTL_HOURS } from '@/lib/sign-offer';
  ...
  useEffect(() => {
    ...
    getDocRequest(token)
      .then(r => {
        ...
        const submission = (r.submissions || []).find(s => s.docType === SIGNED_OFFER_DOC);
        ...
        <div className="rounded-2xl border border-[#E4E6EA] bg-white p-6 shadow-sm">
          ...
          {phase === 'expired' && (
            <div className="mt-6 flex flex-col items-center gap-2 py-6 text-center text-gray-500">
              ...
              <p className="text-sm">
                The upload link was valid for {SIGN_OFFER_TTL_HOURS} hours. Please ask HR for a new
                one.
              </p>
            </div>
          )}
          ...
          {phase === 'ready' && (
            <div className="mt-5 space-y-4">
              ...
              <p className="text-[13px] leading-relaxed text-gray-600">
                ...
                <strong> under 5 MB</strong>. This link is valid for {SIGN_OFFER_TTL_HOURS} hours.
              </p>
              <input
                type="file"
